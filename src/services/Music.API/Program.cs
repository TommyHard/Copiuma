...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                var queue = sp.GetRequiredService<AudioProcessingQueue>();
                CopiumaMetrics.RegisterAudioQueueDepth(() => queue.Count);
            ...
            // Observability: /metrics — Prometheus scrape endpoint
            if (otelEnabled)
                app.MapPrometheusScrapingEndpoint();

            // Observability: health endpoints
            // /health/live  — без проверок зависимостей; жив ли процесс.
            // /health/ready — только проверки с тегом "ready"
    ...
    /// <summary>
    /// Заглушка, чтобы DI выполнил фабрику и зарегистрировал
    /// observable-gauge для AudioProcessingQueue.Count на старте
    /// </summary>
