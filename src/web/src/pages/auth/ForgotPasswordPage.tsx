...
export function ForgotPasswordPage() {
    ...
    async function onSubmit(e: FormEvent) {
        ...
        try {
            ...
            setFieldError(true);
            setError(extractError(err) ?? 'Не получилось отправить ссылку.');
        } finally {
            setSubmitting(false);
        }
    }
    ...
    if (done) {
        return (
            <div className="space-y-6 text-center mt-16">
                ...
                <p className="text-fg-muted text-justify">
    ...
    return (
        <div className="space-y-6">
            <header>
                <h1 className="text-2xl font-semibold text-left">Сброс пароля</h1>
                <p className="mt-2 text-sm text-fg-muted text-justify">
                    Введите свой адрес электронной почты, и мы вышлем Вам ссылку для повторного входа в Ваш аккаунт.
                </p>
