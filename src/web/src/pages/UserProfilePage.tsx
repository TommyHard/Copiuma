...
import { SettingsIcon, TrashIcon } from '@/shared/ui/icons';
                ...
                <div className="px-8 py-4 flex items-center gap-4 bg-black/5 backdrop-blur-md sticky top-0 z-20">
                    ...
                    {isMe && (
                        <Tooltip content="Настройки" position="bottom">
                            <Link
                                to="/settings"
                                className="p-2 flex items-center justify-center rounded text-fg-muted hover:text-fg hover:bg-accent/20 transition-colors"
                            >
